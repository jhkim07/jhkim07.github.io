...
<section id="about" class="section section-hero">
  <div class="container hero-grid">
    ...
    <div class="hero-text">
      <p class="tagline">Associate Professor · <a herf="https://aix.gnu.ac.kr"> AiX Lab (Former: Cyber Safety) Lab </a> · <a href="https://gnu.ac.kr">Gyeongsang National University</a></p>
      ...
      <div class="contact-info">
        ...
        <div class="contact-item">
          <strong>Lab:</strong>
          <a href="https://aix.gnu.ac.kr" target="_blank">AiX Lab@GNU</a>
        </div>
        <div class="contact-item">
          <strong>CV:</strong>
          <a href="{{ '/assets/cv.pdf' | relative_url }}" target="_blank">Download CV</a>
        </div>
      </div>
    </div>
  </div>
