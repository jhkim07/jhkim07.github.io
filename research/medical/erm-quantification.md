...
<div style="margin: 2rem 0; text-align:center;">
  <img src="{{ '/assets/images/research/erm/Architecture.png' | relative_url }}" alt="ERM System Architecture" style="max-width: 90%; border-radius: 0.5rem; border:1px solid #333;" />
