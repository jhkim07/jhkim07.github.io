    ...
    <div class="research-layout">
      ...
      <div class="research-content">
        ...
        <div id="medical-llm" class="research-content-section">
          ...
          <ul class="section-text">
            <li><strong>Ophtimus-V2-Tx:</strong> An 8B-parameter ophthalmology LLM trained on case reports and evaluated with CliBench-based coding.</li>
            <li><strong>ERM Quantification:</strong> Low-cost and fast SD-OCT based epiretinal membrane detection and thickness quantification.</li>
          </ul>
        </div>
